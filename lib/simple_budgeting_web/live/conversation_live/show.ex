defmodule SimpleBudgetingWeb.ConversationLive.Show do
  use SimpleBudgetingWeb, :live_view
  alias SimpleBudgetingWeb.ConversationLive.FormComponent
  alias SimpleBudgetingWeb.ConversationLive.MessageFormComponent
  alias SimpleBudgeting.Conversations
  alias SimpleBudgeting.Schema.Conversation
  alias SimpleBudgeting.Messages
