defmodule SimpleBudgetingWeb.ConversationLive.FormComponent do
    ...
    case Conversations.create_conversation(conversation_params) do
      {:ok, conversation} ->
        ...
        Messages.create_message(conversation.id, %{
          role: :system,
          content: "You are a helpful assistant. Respond with MARKDOWN formatting only."
        })
        ...
        {:noreply,
         ...
         |> push_navigate(to: ~p"/ai_conversations/#{conversation.id}")}
