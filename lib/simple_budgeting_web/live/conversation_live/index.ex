defmodule SimpleBudgetingWeb.ConversationLive.Index do
  ...
  def mount(_params, _session, socket) do
    IO.inspect(Conversations.load_conversations())
    socket =
      socket
  ...
  @impl true
  def handle_info(
        {SimpleBudgetingWeb.ConversationLive.FormComponent, {:saved, conversation}},
        socket
      ) do
